...
<table border="1" cellspacing="0" width="80%">
    ...
    <c:forEach items="${brands}" var="brand" varStatus="vs">
        <tr align="center">
            ...
            <td><a href="/CookieSessionLoginRegister/selectByIdServlet?id=${brand.id}">修改</a>
                <a href="/CookieSessionLoginRegister/deleteByIdServlet?id=${brand.id}">删除</a></td>
        </tr>
    </c:forEach>
</table>
...
<script>
    function toAdd() {
        //跳转到addBrand.html页面
        location.href="/CookieSessionLoginRegister/addBrand.html";
    }
</script>
</body>
</html>
