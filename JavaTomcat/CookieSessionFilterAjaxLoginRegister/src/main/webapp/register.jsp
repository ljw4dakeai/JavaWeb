...
<script>
    function changeImage() {
        ...
        //修改image标签的src属性
        document.querySelector("#checkCodeImg").src = "checkCodeServlet?" + new Date().getTime()
    }

    document.querySelector("#username").onblur = function () {
        let value = document.querySelector("#username").value;
        axios.post("checkUserNameServlet", "username="+value).then(resp => {
            if(resp.data){
                document.querySelector("#username_err").style.display = ""
            }else {
